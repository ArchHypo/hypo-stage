...
| `docs/e2e/walkthrough-videos/` | — | Walkthrough clips for [Real usage walkthrough](docs/real-usage-walkthrough.md). Run `node scripts/copy-walkthrough-videos.js` after E2E to refresh. Committed. |
